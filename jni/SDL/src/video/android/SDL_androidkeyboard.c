...
if(keycode==106)//left pad button
    keycode=38;//j
if(keycode==107)//right pad button
    keycode=39;//k

if(keycode==102)//left button
    keycode=40;//l
if(keycode==104)//left trigger
    keycode=41;//m

if(keycode==103)//right button
    keycode=46;//r
if(keycode==105)//right trigger
    keycode=47;//s

//Up Down Left Right are fine
//u = 19
//d = 20
//l = 21
//r = 22
